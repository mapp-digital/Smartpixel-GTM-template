...
const runMapp = () => {
    ...
    if (data.products && data.products.length > 0) {
        data.products.forEach(product => {
            ...
            const valids = ['view', 'basket', 'confirmation', 'list', 'addToCart', 'deleteFromCart', 'checkout', 'addToWishlist', 'deleteFromWishlist', 'clickRepo', 'displayRepo'];
